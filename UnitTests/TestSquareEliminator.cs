...
namespace Vsite.Oom.Battleship.UnitTests
{
    ...
    {
        [TestMethod]
        public void ToEliminateReturns18ShipSquaresAndSurroundingSquaresFor4x3_4x6()
        {
        ...
        [TestMethod]
        public void ToEliminateReturns8ShipSquaresAndSurroundingSquaresFor0x3_0x4()
        {
            var eliminator = new SquareEliminator(10, 10);
        ...
        [TestMethod]
        public void ToEliminateReturns12ShipSquaresAndSurroundingSquaresFor7x5_9x5()
        {
            var eliminator = new SquareEliminator(10, 10);
